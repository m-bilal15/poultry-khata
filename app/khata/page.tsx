...
export default function KhataPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Desktop: 2-col (form | weekly summary) / Mobile: stacked */}
        ...
        <div className="bg-white rounded-3xl p-5" style={{ boxShadow: '0 2px 16px rgba(0,0,0,0.06)' }}>
          ...
          <div className="space-y-1">
            {last7Days.map((date) => {
              ...
              const dayLabel = new Date(date + 'T00:00:00').toLocaleDateString(lang === 'ur' ? 'ur-PK' : 'en-PK', {
              ...
              if (!entry) {
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2.5 rounded-2xl ${isSelected ? 'bg-green-50' : 'hover:bg-gray-50'}`}
                  >
